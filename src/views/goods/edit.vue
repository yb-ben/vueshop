    ...
    <el-container>
      ...
      <el-main>
        <el-form>
          ...
          <single-selector :default-image="image_url" @submit-images="handleSubmitImages"></single-selector>
          ...
          <el-form-item label="限购" :label-width="formLabelWidth">
            <el-checkbox :label="1" @change="onLimitChange" :checked="(limit && limit[0])?true:false">限制每人可购买数量
            </el-checkbox>
            <div>
    ...
    export default {
        ...
        created() {
            ...
            Promise.all([detail(this.$route.params.id)]).then(res => {
                ...
                this.image_id = d0.image_id;
                this.content = d0.content.content;
                this.count = d0.count;
                this.image_url = d0.image_url;
