  ...
  <div class="app-container">
    <el-container>
        ...
        <el-form :inline="true" :model="paginate" class="demo-form-inline">
          ...
          <el-form-item label="商品分类">
            <el-select v-model="paginate.cate_id" placeholder="请选择">
              <el-option v-for="item in cate" :key="item.id" :label="item.name" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="价格">
            <el-row>
              ...
              <el-col :span="11">
                <div class="grid-content bg-purple">
                  <el-input v-model="paginate.price[1]"></el-input>
                </div>
              </el-col>
            </el-row>
          </el-form-item>
      ...
      <el-header>
        ...
        <el-button v-show="paginate.status !== '0' " @click="downGoods">下架</el-button>
        <el-button v-show="paginate.status !== '1' || paginate.status !== '2' " @click="deleteGoods">删除</el-button>
      </el-header>
      <el-main>
        <el-table
...
<script>
import { goodsList, takeUp, takeDown, batchDelete } from "@/api/goods";
...
export default {
  ...
  methods: {
    ...
    resetSearch(){
      //重置
      this.$set(this.paginate,'kw','');
      this.$set(this.paginate,'price',[null,null]);
      this.$set(this.paginate,'cate_id',null);
    },
